//
//  ByPopulationAscendingViewController.m
//  States
//
...
#import "ByPopulationAscendingViewController.h"
#import "StatesAppDelegate.h"

@implementation ByPopulationAscendingViewController

- (NSArray *)states {
    return [(StatesAppDelegate *)[[UIApplication sharedApplication] delegate] statesAscendingByPopulation];
}
