...
#import "ByAreaAscViewController.h"
#import "StatesAppDelegate.h"

@implementation ByAreaAscViewController

- (NSArray *)states {
    return [(StatesAppDelegate *)[[UIApplication sharedApplication] delegate] statesByAscArea];
}
